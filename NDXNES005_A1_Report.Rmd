...
Coding for Part II's Experiment 1 and 2 was completed using RStudio 2024.09.0+375 ("Cranberry Hibiscus" Release) and was based on R and MATLAB code provided by Professor Tim Gebbie(STA4028Z).

Version control: managed with Git and GitHub.

To view repository, click on link: [PT-Assignment 1](https://github.com/NesanNaidoo/Portfolio-Theory-Assignment-1-Backtesting)
